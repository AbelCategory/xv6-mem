...
int main(int argc, char* argv[]) {
  ...
  for (int i = 0; i < num_ops; ++i) {
    ...
    // if(ptr[1197] != 0) {
    //   uint size = *(uint *)(ptr[1197] - 12);
    //   if(size > 100000) {
    //     printf("error now!!!\n");
    //     exit(0);
    //   }
    //   printf("pos: %l the size of 1197: %d\n", (long long)ptr[1197], *(uint *)(ptr[1197] - 12));
    // }
